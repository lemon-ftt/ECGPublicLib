#
#  Be sure to run `pod spec lint ECGPublicLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Fighter-FT" => "fantantanyx@sina.com" }
  # Or just: s.author    = "Fighter-FT"
  # s.authors            = { "Fighter-FT" => "" }
  # s.social_media_url   = "http://twitter.com/Fighter-FT"
  ...
  s.source       = { :git => "https://github.com/fttios/ECGPublicLib.git", :tag => "#{s.version}" }
  ...
  s.subspec 'ECGCustomCell' do |cell|
      ...
      cell.dependency 'ECGPublicLib/model'
      cell.dependency 'ECGPublicLib/ECGLayoutConstraint'
  ...
  s.subspec 'ECGLayoutConstraint' do |lc|
